...
/*
        ...
        for (int i = alphabetReverse.length - 1; i >= 0; i--) {
            alphabetReverse[i] += 'z'-i;
        }

        System.out.println(Arrays.toString(alphabet));
        System.out.println(Arrays.toString(alphabetReverse));
*/
...
The decimal set:
     ...
     120  x   121  y   122  z   day33_class_notes.txt  {   124  |   125  }   126  ~   127 del
