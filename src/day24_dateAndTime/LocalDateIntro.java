...
public class LocalDateIntro {
    ...
    public static void main(String[] args) {
        ...
        LocalDate today = LocalDate.now(); //2022-11-18

        System.out.println(today);

        LocalDate birthDay = LocalDate.of(1990,1,16);
        ...
        today = today.plusYears(1); // 2023-11-18
        ...
        graduationDate = graduationDate.plusYears(2);//2027-11-18
