...
public class IPhone {
    ...
    public void setColor(String color) {
        ...
        if(Arrays.asList(colors).contains(color)){
            ...
            System.err.println("Invalid color: "+color+"\nColor can be "+Arrays.toString(colors));
            System.exit(1);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof IPhone){ // if the object is IPhone
            if(model.equals(((IPhone) obj).model)){ // if the model of the Iphone is equal to th given Iphone's model
                if(color.equals(  ((IPhone) obj).color)){ // if the color of the Iphone is equal to th given Iphone's color
                    return true;
                }
            }
        }else{
