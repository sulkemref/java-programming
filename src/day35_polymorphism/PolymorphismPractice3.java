...
public class PolymorphismPractice3 {
    ...
    public static void main(String[] args) {
        ...
        int countDevelopers = 0,countTesters = 0,countTeachers = 0,countDrivers = 0;
        for(Employee each:employees){
            countDevelopers+=(each instanceof Developer)?1:0;
            countTesters+=(each instanceof Tester)?1:0;
            countTeachers+=(each instanceof Teacher)?1:0;
            countDrivers+=(each instanceof Driver)?1:0;
        }
