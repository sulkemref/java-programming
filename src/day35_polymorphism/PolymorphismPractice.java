...
public class PolymorphismPractice {
    ...
    public static void main(String[] args) {
       ...
       // obj1.sleep();
        ...
        boolean iaAudi = car instanceof Audi;

        boolean isElectrickCar = car instanceof Electric;
        ...
        System.out.println("iaAudi = " + iaAudi);
        System.out.println("isElectrickCar = " + isElectrickCar);
